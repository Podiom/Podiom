...
<style>
  ...
  .modal { width: 100%; max-width: 460px; max-height: 100%; overflow-y: auto; overscroll-behavior: contain; background: #fffdfb; border: 1px solid #ede4d9; border-radius: 18px; padding: 22px 24px; box-shadow: 0 24px 60px -20px rgba(43, 37, 32, 0.4); }
