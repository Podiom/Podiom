...
func New(opts Options) *Server {
	...
	mux.HandleFunc("/api/onboarding", s.handleOnboardingState)
	mux.HandleFunc("/api/onboarding/complete", s.handleOnboardingComplete)
	mux.HandleFunc("/api/onboarding/token", s.handleOnboardingToken)
