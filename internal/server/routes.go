...
func (s *Server) apiRoutes() []apiRoute {
	return []apiRoute{
		...
		{"/api/provider-status", s.handleProviderStatus},
		{"/api/provider-login", s.handleProviderLoginStart},
		{"/api/provider-login/", s.handleProviderLogin},
		...
		{"/api/user-profile", s.handleUserProfile},
