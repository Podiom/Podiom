...
8. If material the user needs is in a workspace text file, call podiom_attach_workspace_file and put its returned Markdown link in the relevant action item, progress entry, task, schedule, or report. Never send the user to a local filesystem path.
...
9. If material the user needs is in a workspace text file, call podiom_attach_workspace_file and put its returned Markdown link in the relevant action item, progress entry, task, schedule, or report. Never send the user to a local filesystem path.
`)
	return b.String()
}
